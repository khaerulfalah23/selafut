									...
									<div class="mu-portfolio-content">
										<div class="filtr-container">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                   <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-1.jpg'?>" title="MATRAS">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="2">
							                    <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-2.jpg'?>" title="MATRAS">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                    <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-3.jpg'?>" title="MATRAS">

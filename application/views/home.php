...
<div id="mu-slider">
		<div class="mu-slide">
			...
			<div class="mu-single-slide">
                <img src="<?= base_url().'assets/images/slider-img-7.jpg' ?>" alt="slider img">
			...
			<!-- Start single slide  -->
			<div class="mu-single-slide">
				<img src="<?php echo base_url().'assets/images/slider-img-6.jpg'?>" alt="slider img">
				<div class="mu-single-slide-content-area">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
			...
			<!-- Start single slide  -->
			<div class="mu-single-slide">
				<img src="<?php echo base_url().'assets/images/slider-img-7.jpg'?>" alt="slider img">
				<div class="mu-single-slide-content-area">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="mu-about-area">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="mu-title">
										<h2>Tentang Kami</h2>
										<p>Website Sistem Penyewaan Lapangan Futsal </p>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mu-about-left">
										<img class="" src="<?php echo base_url().'assets/images/img-17.jpeg" '?> ">
									</div>
								</div>
								<div class="col-md-6">
							...
							<div class="row">
									...
									<div class="mu-portfolio-filter-area">
										<ul class="mu-simplefilter">
							                ...
							                <li data-filter="1">Lapangan Sintetis<span>/</span> </li>
							                <li data-filter="2">Lapangan Matras<span>/</span></li>
									...
									<div class="mu-portfolio-content">
										<div class="filtr-container">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                   <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-1.jpg'?>" title="SINTETIS">
								                   	<img class="img-responsive" src="<?php echo base_url().'assets/images/sintetis-1.jpg'?>" alt="image">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                    <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-2.jpg'?>" title="SINTETIS">
							                    	<img class="img-responsive" src="<?php echo base_url().'assets/images/sintetis-2.jpg'?>" alt="image">
								                    <div class="mu-filter-item-content">
								                    	<h4 class="mu-filter-item-title">SINTETIS</h4>
								                    	<span class="fa fa-long-arrow-right"></span>
								                    </div>
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                    <a class="mu-imglink" href="<?php echo base_url().'assets/images/sintetis-3.jpg'?>" title="SINTETIS">
							                    	<img class="img-responsive" src="<?php echo base_url().'assets/images/sintetis-3.jpg'?>" alt="image">
								                    <div class="mu-filter-item-content">
								                    	<h4 class="mu-filter-item-title">SINTETIS</h4>
								                    	<span class="fa fa-long-arrow-right"></span>
								                    </div>
